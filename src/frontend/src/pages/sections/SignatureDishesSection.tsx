...
const dishes = [
  ...
  },
  {
    ...
    description:
      "Slow-cooked tender mutton with saffron-infused basmati, caramelized onions, and the pure essence of Hyderabadi dum.",
    price: "₹379",
    tag: "Bestseller",
  ...
  },
  {
    ...
    description:
      "Premium saffron-drenched basmati with tender chicken, dried fruits, and aromatic whole spices — rich yet delicately balanced.",
    price: "₹329",
    tag: "Signature",
  ...
  },
  {
    ...
    description:
      "Juicy prawns marinated in coastal spice blend, layered with saffron rice and sealed to perfection in our clay matka.",
    price: "₹399",
    tag: "Seasonal",
...
function DishCard({
  ...
  return (
    <div
      ...
      className={`group relative flex flex-col bg-card rounded-sm overflow-hidden shadow-card transition-all duration-700 ease-out hover:-translate-y-1 hover:shadow-elevated ${
