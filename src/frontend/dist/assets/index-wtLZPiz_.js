...
function MatkaLogoSmall() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      width: "28",
      height: "28",
...
const socialLinks = [
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiInstagram, { size: 16 }),
    label: "Instagram",
    href: "https://instagram.com/matkabiryani"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiFacebook, { size: 16 }),
    label: "Facebook",
    href: "https://facebook.com/matkabiryani"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiX, { size: 16 }),
    label: "X (Twitter)",
    href: "https://x.com/matkabiryani"
  }
];
function scrollTo$3(href) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MatkaLogoSmall, {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg text-foreground", children: "Matka Biryani" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground leading-relaxed max-w-[220px]", children: "Slow-cooked dum biryani sealed with tradition — since 1997." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-body text-xs tracking-[0.2em] uppercase text-primary mb-5", children: "Quick Links" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-body text-xs tracking-[0.2em] uppercase text-primary mb-5", children: "Follow Us" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: socialLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: link.href,
                target: "_blank",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-body text-xs tracking-[0.2em] uppercase text-primary mb-5", children: "Contact" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 14, className: "mt-0.5 shrink-0" }),
                    "+91 12345 67890"
                  ]
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  ...
                  className: "flex items-start gap-2.5 font-body text-sm text-muted-foreground hover:text-primary transition-colors duration-200",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 14, className: "mt-0.5 shrink-0" }),
                    "info@matkabiryani.com"
                  ]
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2.5 font-body text-sm text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 14, className: "mt-0.5 shrink-0" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-px bg-border/30 mb-6" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-muted-foreground", children: [
            "© ",
            year,
            " Matka Biryani. All Rights Reserved."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-muted-foreground", children: [
...
function scrollTo$2(href, close) {
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      "data-ocid": "navbar",
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "bg-background/95 backdrop-blur-md border-b border-border/40 py-3" : "bg-transparent py-5"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MatkaLogo, {}),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display text-xl text-foreground leading-tight", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs font-body text-primary tracking-[0.2em] uppercase", children: "Matka" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-base leading-none", children: "Biryani" })
                ] })
              ]
            }
          ),
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden bg-background/98 backdrop-blur-md border-t border-border/40 px-6 py-6 flex flex-col gap-5", children: [
          navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => scrollTo$2(link.href, () => setMenuOpen(false)),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              type: "button",
              onClick: () => scrollTo$2("#contact", () => setMenuOpen(false)),
...
function BrandStorySection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "story", className: "py-24 md:py-32 bg-section-alt", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref: imgRef,
        className: `relative transition-all duration-900 ease-out ${imgVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"}`,
        style: { transitionDuration: "900ms" },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-sm overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-tr from-black/30 to-transparent" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -bottom-6 -right-6 bg-card p-6 max-w-[200px] shadow-elevated rounded-sm hidden md:block", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-3xl text-primary leading-none", children: "26" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-muted-foreground mt-1 leading-snug tracking-wide uppercase", children: [
              "Years of",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              "Authentic Cooking"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-4 -left-4 w-16 h-16 border-t border-l border-primary/40 rounded-tl-sm hidden md:block" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ...
      {
        ref: textRef,
        className: `transition-all duration-900 ease-out ${textVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`,
        style: { transitionDuration: "900ms", transitionDelay: "150ms" },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-[0.3em] uppercase text-primary mb-4", children: "Our Legacy" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl md:text-5xl text-foreground mb-6 leading-tight", children: [
            "Our Legacy of",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic text-primary", children: "Slow-Cooking." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-px bg-primary opacity-60 mb-8" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-base text-muted-foreground leading-relaxed", children: [
              "Embracing centuries-old",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "text-foreground/80 not-italic font-medium", children: "'Dum-Pukht'" }),
              " ",
              "techniques, we seal each Matka Biryani with fragrant dough, allowing fresh, authentic spices to weave their magic as the biryani cooks slowly over low heat — preserving every drop of flavor and aroma."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base text-muted-foreground leading-relaxed", children: "The clay pot is not just a vessel. It breathes. It absorbs the spices, it tempers the heat, and it transforms raw ingredients into a dish that carries the memory of a thousand meals." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base text-muted-foreground leading-relaxed", children: "Every matka that leaves our kitchen has been touched by hands that have spent decades perfecting a single craft — the art of real biryani." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-5 mt-10", children: [
            {
              title: "Sealed Dum",
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm font-medium text-foreground", children: item.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground mt-0.5", children: item.desc })
              ]
            },
            item.title
          )) })
...
function CtaSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-24 md:py-32 bg-background relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 opacity-5",
        style: {
          backgroundImage: "radial-gradient(ellipse 80% 80% at 50% 50%, oklch(0.72 0.22 48) 0%, transparent 70%)"
        },
        "aria-hidden": "true"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-[0.3em] uppercase text-primary mb-5", children: "Ready to Order?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl md:text-6xl text-foreground mb-5 leading-tight", children: [
            "Craving Real ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic text-primary", children: "Biryani?" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-px bg-primary mx-auto opacity-60 mb-8" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base text-muted-foreground mb-10 leading-relaxed max-w-lg mx-auto", children: "Indulge in an authentic clay pot experience. Reserve your table or order online for delivery — and taste the difference of real dum." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4 justify-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                type: "button",
                "data-ocid": "cta-reserve",
                onClick: () => scrollTo$1("#contact"),
                className: "px-10 py-3.5 border border-border/40 text-foreground font-body font-medium text-sm tracking-wider rounded-sm hover:border-primary/50 hover:text-primary transition-smooth",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              backgroundImage: "url('/assets/generated/hero-biryani.dim_1920x1080.jpg')"
            },
            "aria-hidden": "true"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(to right, oklch(0.10 0 0 / 0.94) 0%, oklch(0.10 0 0 / 0.78) 45%, oklch(0.10 0 0 / 0.30) 100%), linear-gradient(to top, oklch(0.10 0 0 / 0.70) 0%, transparent 60%)"
            },
            "aria-hidden": "true"
          }
        ),
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-[0.3em] uppercase text-primary mb-5", children: "Since 1997 · Hyderabad" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-5xl md:text-6xl lg:text-7xl leading-[1.08] text-foreground mb-6", children: [
                    "Authentic Dum Biryani,",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic text-primary", children: "Sealed with Tradition" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base md:text-lg text-muted-foreground leading-relaxed max-w-lg mb-10", children: "Experience the timeless art of slow-cooking, where rich flavors and aromatic spices are nurtured within a sealed clay pot for an unparalleled culinary journey." }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-10 mt-14 pt-8 border-t border-foreground/10", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl text-primary", children: stat.value }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground tracking-wide mt-0.5", children: stat.label })
                  ] }, stat.label)) })
                ]
              }
            )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs tracking-[0.2em] uppercase text-muted-foreground", children: "Scroll" }),
...
const dishes = [
  {
    id: "mughlai",
    name: "The Royal Mughlai Biryani",
    description: "Fragrant basmati rice layered with slow-cooked chicken in rich Mughlai spice gravy, sealed and dum-cooked in a clay pot.",
    price: "₹349",
    tag: "Chef's Choice",
  ...
  },
  {
    ...
    description: "Slow-cooked tender mutton with saffron-infused basmati, caramelized onions, and the pure essence of Hyderabadi dum.",
    price: "₹379",
    tag: "Bestseller",
  ...
  {
    id: "zafrani",
    name: "Zafrani Claypot Biryani",
    description: "Premium saffron-drenched basmati with tender chicken, dried fruits, and aromatic whole spices — rich yet delicately balanced.",
    price: "₹329",
    tag: "Signature",
  ...
  },
  {
    ...
    description: "Juicy prawns marinated in coastal spice blend, layered with saffron rice and sealed to perfection in our clay matka.",
    price: "₹399",
    tag: "Seasonal",
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden aspect-[4/3]", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-3 left-3 px-2.5 py-1 bg-primary/90 text-primary-foreground font-body text-xs tracking-wider rounded-sm", children: dish.tag })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 flex flex-col flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl text-foreground mb-2 leading-snug", children: dish.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground leading-relaxed flex-1", children: dish.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-5 pt-4 border-t border-border/40", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg text-primary", children: dish.price }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                "data-ocid": `dish-order-${dish.id}`,
                className: "font-body text-xs tracking-wider uppercase text-foreground/70 hover:text-primary transition-colors duration-200 flex items-center gap-1.5",
                children: "Order →"
              }
            )
          ] })
...
function SignatureDishesSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "menu", className: "py-24 md:py-32 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref: headingRef,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-[0.3em] uppercase text-primary mb-4", children: "Our Menu" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl text-foreground mb-4", children: "Signature Dishes" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-px bg-primary mx-auto opacity-60" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base text-muted-foreground mt-6 max-w-xl mx-auto leading-relaxed", children: "Each biryani is crafted using centuries-old dum technique — slow-cooked in sealed clay pots to lock in every drop of flavor." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6", children: dishes.map((dish, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(DishCard, { dish, delay: i * 100 }, dish.id)) })
  ] }) });
}
const testimonials = [
  {
    id: "t1",
    quote: "Simply the best biryani I've ever tasted. The moment the matka was unsealed at the table, the aroma was something else entirely.",
    author: "Anjali R.",
    location: "Hyderabad",
    rating: 5
  },
  {
    id: "t2",
    quote: "An unforgettable dining experience. The slow-cooked mutton just melts on the tongue. I've recommended Matka Biryani to everyone I know.",
    author: "David K.",
    location: "Bangalore",
    rating: 5
  },
  {
    id: "t3",
    quote: "Every spoonful is a burst of traditional flavor. The rice is perfectly cooked — each grain separate, fragrant, and full. Truly unmatched.",
    author: "Priya S.",
    location: "Mumbai",
    rating: 5
  },
  {
    id: "t4",
    quote: "I've tried biryani across India and abroad. Nothing comes close to the depth of flavor you get from a clay-sealed dum pot. Matka Biryani nails it.",
    author: "Arjun M.",
    location: "Delhi",
    rating: 5
  }
...
function StarRating({ count }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-0.5 mb-4", children: STAR_KEYS.slice(0, count).map((key) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "svg",
    {
      className: "w-3.5 h-3.5 text-primary fill-current",
      viewBox: "0 0 12 12",
      "aria-hidden": "true",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M6 1L7.5 4.5L11 5L8.5 7.5L9 11L6 9.5L3 11L3.5 7.5L1 5L4.5 4.5Z" })
    },
    key
  )) });
}
function TestimonialCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: { transitionDelay: `${delay}ms` },
      className: `flex flex-col bg-card rounded-sm p-7 shadow-card border border-border/20 transition-all duration-700 ease-out hover:shadow-elevated hover:-translate-y-0.5 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-4xl text-primary/30 leading-none mb-3 select-none", children: '"' }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StarRating, { count: item.rating }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("blockquote", { className: "font-body text-sm text-muted-foreground leading-relaxed flex-1 italic", children: item.quote }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 pt-5 border-t border-border/30", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm font-medium text-foreground", children: item.author }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground mt-0.5", children: item.location })
        ] })
      ]
    }
  );
...
function TestimonialsSection() {
  const { ref: headingRef, isVisible: headingVisible } = useScrollReveal();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 md:py-32 bg-section-alt", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref: headingRef,
        className: `text-center mb-16 transition-all duration-700 ease-out ${headingVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-[0.3em] uppercase text-primary mb-4", children: "Guest Voices" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl text-foreground mb-4", children: "What Our Guests Say" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-px bg-primary mx-auto opacity-60" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6", children: testimonials.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(TestimonialCard, { item, delay: i * 100 }, item.id)) })
  ] }) });
}
const reasons = [
  {
...
function ReasonCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref,
      style: { transitionDelay: `${delay}ms` },
      className: `flex flex-col items-center text-center p-8 transition-all duration-700 ease-out group ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-primary mb-6 transition-transform duration-300 group-hover:scale-110 group-hover:-translate-y-1", children: item.icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-px bg-primary/40 mb-5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl text-foreground mb-3", children: item.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground leading-relaxed max-w-[220px]", children: item.desc })
      ]
    }
  );
}
function WhyUsSection() {
  const { ref: headingRef, isVisible: headingVisible } = useScrollReveal();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "why-us", className: "py-24 md:py-32 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref: headingRef,
        className: `text-center mb-12 transition-all duration-700 ease-out ${headingVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-[0.3em] uppercase text-primary mb-4", children: "The Difference" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl text-foreground mb-4", children: "Why Choose Us" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-px bg-primary mx-auto opacity-60" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4", children: reasons.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ReasonCard, { item, delay: i * 100 }, item.id)) })
  ] }) });
}
function App() {
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(SignatureDishesSection, {}),
